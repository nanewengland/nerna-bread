...
if (!class_exists("Bread")) {
	class Bread {
		...
		*/
		...
		function bmlt_meeting_list($atts = null, $content = null) {
            ...
            //$this->mpdf->AddSpotColor('PANTONE Reflex Blue U', 100, 89, 0, 0);
            //$this->mpdf->SetDefaultBodyCSS('color', '#0055a4'); // Patrick
   ...
   // Patrick 
			$header_style .= "background-color: spot(PANTONE Reflex Blue U, 50%, 100, 89, 0, 0);";
       ...
       // Patrick J remove space between format values
       //$this->mpdf->WriteHTML('td{color: spot(PANTONE Reflex Blue U, 50%, 100, 89, 0, 0) !important;}',1);
       $meeting_value['formats'] = str_replace(',', ',', $meeting_value['formats']);
							...
							// Patrick Changes shorten names of addresses
							$data = str_replace('Street', 'St', $data);
							$data = str_replace('Massachusetts', 'Mass', $data);
							$data = str_replace('Avenue', 'Av', $data);	
							$data = str_replace('Square', 'Sq', $data);
							$data = str_replace('Road', 'Rd', $data);
							$data = str_replace('Parkway', 'Prkwy', $data);
							$data = str_replace('Way', 'Wy', $data);
							$data = str_replace('Drive', 'Dr', $data);
							$data = str_replace('North Central', 'N. Central', $data);
							$data = str_replace('North Main', 'N. Main', $data);
							$data = str_replace('East Main', 'E. Main', $data);
							$data = str_replace('South Main', 'S. Main', $data);
							$data = str_replace('West Main', 'W. Main', $data);
							...
							// Patrick Changes shorten names of location names
							$data = str_replace('Falmouth Church of the Nazarene', 'Falmouth Chrch of Nazarene', $data);
							$data = str_replace('Pepperell Christian Fellowship Church', 'Pepperell Chrstn Fellowship Chrch', $data);
							$data = str_replace('StepRox Recovery Support Center', 'StepRox Recvry Support Cntr', $data);
							$data = str_replace('Across from Boston Medical Center Emergency Room', 'Across Boston Med Cntr ER', $data);
							$data = str_replace('St Therese Old Catholic Church', 'StThereseCathlicChrch', $data);
							$data = str_replace('First Parish Unitarian Universalist Church', 'FirstParishUnitarianUnivrslstChrch', $data);
       $data = str_replace('Chapel of St John the Divine', 'ChapelStJohnDivine', $data);
							...
							$data = str_replace('Heritage Christian Life Center', 'HritgeChrstnLifeCntr', $data);
							$data = str_replace('St. Peters By the Sea Episcopal Church', 'St Peters Episc Chrch', $data);
							$data = str_replace('Christian Life Center', 'Christn Life Cntr', $data);
							$data = str_replace('Saint John the Evangelist Church', 'St John\'s Evangelist Church', $data);
							$data = str_replace('Roslindale Community Center', 'RoslindleComCntr', $data);
							
							
							
							
							$data = str_replace('Housing Corporation', 'Housng Corp', $data);
							$data = str_replace('Saint Vincent de Paul', 'StVincentdePaul', $data);
							$data = str_replace('Deacon Amos Harrington', 'DeaconAmosHarrington', $data);
							$data = str_replace('Worthington Street', 'WortngtnSt', $data);
							$data = str_replace('United Methodist Church', 'UntedMethdstChrch', $data);
							$data = str_replace('Saints Constantine & Helen Greek Orthodox Church', 'Sts Constntne&Helen GrkOrthChrch', $data);
							$data = str_replace('Greenwood Memorial Universalist Methodist Church', 'Grnwood Mem Chrch', $data);
							$data = str_replace('Fourth Presbyterian Church', '4thPresbChrch', $data);
							$data = str_replace('Healthcare for the Homeless', 'HlthcareforHomeless', $data);
							$data = str_replace('West Gloucester', 'W. Gloucester', $data);
							$data = str_replace('North End', 'N. End', $data);
							$data = str_replace('High School', 'High Schl', $data);
							$data = str_replace('Maple Ridge Church and Community Center', 'MapleRidgeChrch&CommCntr', $data);
							$data = str_replace('John Hope Settlement house', 'JohnHopeSetlmntHse', $data);
							$data = str_replace('Saint Johns\' and Saint James\' Church', 'StJohns & StJames Chrch', $data);
							$data = str_replace('Seventh Day Adventist Church', '7thDayAdventistChrch', $data);
							$data = str_replace('Gloucester Trinitarian Church', 'GloucesterTrinitarianChrch', $data);
							$data = str_replace('First Church Unitarian Universalist', 'FirstChrchUnitarianUnivrslst', $data);
							$data = str_replace('Universalist Unitarian Church', 'UnivrslstUnitrinChrch', $data);
							
							$data = str_replace('Veteran\'s', 'Vets', $data);
							$data = str_replace('Administration', 'Admin', $data);
							$data = str_replace('Parish', 'Prsh', $data);
							$data = str_replace('United', 'Untd', $data);
							$data = str_replace('Protestant', 'Protstnt', $data);
							$data = str_replace('Congregational', 'Cong', $data);
							$data = str_replace('Presbyterian', 'Presb', $data);
							$data = str_replace('Building', 'Bldg', $data);
							$data = str_replace('Presbyterian', 'Presb', $data);
							$data = str_replace('Community', 'Comm', $data);
							$data = str_replace('Recreational', 'Rec', $data);
							$data = str_replace('Resource', 'Rsrc', $data);
							$data = str_replace('Medical', 'Med', $data);
							//$data = str_replace('Recovery', 'Recvry', $data);
							//$data = str_replace('Center', 'Cntr', $data);
							$data = str_replace('Saint', 'St', $data);
							$data = str_replace('Episcopal', 'Episc', $data);
							//$data = str_replace('Church', 'Chrch', $data);
							//$data = str_replace('Chrch St', 'Church St', $data);
							$data = str_replace('Headquarters', 'Headqrtrs', $data);
							$data = str_replace('Methodist', 'Methdst', $data);
							
							// Patrick Changes shorten extra location info
							//$data = str_replace('info', $meeting_value['location_info'], $data);
							//$data = str_replace('Building', 'Bldg', $data);
							//$data = str_replace('building', 'bldg', $data);
							//$data = str_replace('floor', 'flr', $data);
							//$data = str_replace('Room', 'Rm', $data);
      ...
      // Patrick
//$this->mpdf->AddSpotColor('PANTONE Reflex Blue U', 50, 100, 90, 0); //pjspot

//$this->mpdf->SetFillSpotColor('PANTONE Reflex Blue U');
//$this->mpdf->RoundedRect(80,40,50,50,5,'F');

//$this->mpdf->SetFillColor('PANTONE Reflex Blue U');
//$this->mpdf->RoundedRect(60, 30, 68, 8, 2, '13', 'DF');


$this->options['custom_section_content'] = "<p>&nbsp;</p><table style=\"width: 100%;\">
<tbody>
<tr>
<td style=\"padding: 3pt; text-align: center; background-color: spot(PANTONE Reflex Blue U, 50%, 100, 89, 0, 0);\"><span style=\"font-size: 12pt;\"><strong><span style=\"color: #ffffff;\">MEETING FORMAT LEGEND</span></strong></span></td>
</tr>
</tbody>
</table>
<p>&nbsp;</p>
<table id=\"meetingInfo\" style=\"font-size: 8pt; color: #0055a4; width: 100%;\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">
<tbody>
<tr>
<td style=\"width: 15%;\">BT</td>
<td>Basic Text</td>
...
<td>Beginners</td>
<td style=\"width: 15%;\">O</td>
<td>Open</td>
</tr>
<tr>
<td style=\"width: 15%;\">BK</td>
<td>Book Study</td>
...
<td>Speaker/Discussion</td>
</tr>
<tr>
<td style=\"width: 15%;\">ES</td>
<td>Español</td>
<td style=\"width: 15%;\">St</td>
<td>Step</td>
</tr>
<tr>
<td style=\"width: 15%;\">GL</td>
<td>Gay/Lesbian/Transgender</td>
...
<td style=\"width: 15%;\">TW</td>
<td>Traditions Workshop</td>
</tr>
<tr>
<td style=\"width: 15%;\">IW</td>
<td>It Works - How and Why</td>
<td style=\"width: 15%;\">WC</td>
<td>Wheelchair</td>
</tr>
<tr>
<td style=\"width: 15%;\">JT</td>
<td>Just for Today</td>
<td style=\"width: 15%;\">W</td>
<td>Women</td>
</tr>
<tr>
<td style=\"width: 15%;\">LC</td>
<td>Living Clean</td>
<td style=\"width: 15%;\">YP</td>
<td>Young People</td>
</tr>
</tbody>
</table>
...
<tbody>
<tr>
<td style=\"padding: 3pt; text-align: center; background-color: spot(PANTONE Reflex Blue U, 50%, 100, 89, 0, 0);\"><span style=\"font-size: 12pt;\"><strong><span style=\"color: #ffffff;\">PHONE NUMBERS</span></strong></span></td>
</tr>
</tbody>
</table>
